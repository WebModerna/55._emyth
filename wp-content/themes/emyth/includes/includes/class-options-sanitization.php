...
function of_recognized_background_repeat() {
	$default = array(
		'no-repeat' => __( 'No Repetir', 'emyth' ),
		'repeat-x'  => __( 'Repetir Horizontalmente', 'emyth' ),
		'repeat-y'  => __( 'Repetir Verticalmente', 'emyth' ),
		'repeat'    => __( 'Repetir Todo', 'emyth' ),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => __( 'Arriba Izquierda', 'emyth' ),
		'top center'    => __( 'Arriba Centro', 'emyth' ),
		'top right'     => __( 'Arriba Derecha', 'emyth' ),
		'center left'   => __( 'Medio Izquierda', 'emyth' ),
		'center center' => __( 'Medio Centro', 'emyth' ),
		'center right'  => __( 'Medio Derecha', 'emyth' ),
		'bottom left'   => __( 'Abajo Izquierda', 'emyth' ),
		'bottom center' => __( 'Abajo Centro', 'emyth' ),
		'bottom right'  => __( 'Abajo Derecha', 'emyth')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => __( 'Desplazamiento normal', 'emyth' ),
		'fixed'  => __( 'Fija en un lugar', 'emyth')
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => __( 'Normal', 'emyth' ),
		'italic'      => __( 'Cursiva', 'emyth' ),
		'bold'        => __( 'Negrita', 'emyth' ),
		'bold italic' => __( 'Negrita Cursiva', 'emyth' )
		);
