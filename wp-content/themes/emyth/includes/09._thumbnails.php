...
add_image_size('custom-thumb-1200-800', 1200, 800, true);
add_image_size('custom-thumb-1500-1000', 1500, 1000, true);
add_image_size('custom-thumb-1800-1200', 1800, 1200, true);
add_image_size('custom-thumb-2100-1400', 2100, 1400, true);
...
function hmuda_image_sizes($sizes)
{
	$addsizes = array(
		...
		"custom-thumb-600-400"		=>	__("Tamaño recortado 4"),
		"custom-thumb-900-600"		=>	__("Tamaño recortado 5"),
		"custom-thumb-1200-800"		=>	__("Tamaño recortado 6"),
		"custom-thumb-1500-1000"	=>	__("Tamaño recortado 7"),
		"custom-thumb-1800-1200"	=>	__("Tamaño recortado 8"),
		"custom-thumb-2100-1400"	=>	__("Tamaño recortado 9"),
...
function simone_set_image_transient($post_id)
{
	...
	$custom_thumb_1200_800	=	wp_get_attachment_image_src($attachment_id, 'custom-thumb-1200-800');
	$custom_thumb_1500_1000	=	wp_get_attachment_image_src($attachment_id, 'custom-thumb-1500-1000');
	$custom_thumb_1800_1200	=	wp_get_attachment_image_src($attachment_id, 'custom-thumb-1800-1200');
	$custom_thumb_2100_1400	=	wp_get_attachment_image_src($attachment_id, 'custom-thumb-2100-1400');
	...
	$thumb_data = array(
		...
		'custom-thumb-1200-800'		=>	$custom_thumb_1200_800[0],
		'custom-thumb-1500-1000'	=>	$custom_thumb_1500_1000[0],
		'custom-thumb-1800-1200'	=>	$custom_thumb_1800_1200[0],
		'custom-thumb-2100-1400'	=>	$custom_thumb_2100_1400[0],
